              ...
              <div className="p-4" id="print">
                ...
                <div className="mt-6">
                  <div className="mb-4 grid grid-cols-2">
                    <span className="font-bold">Nr.Factură:</span>
                    <span>{invoiceInfo.invoiceNumber}</span>
                    <span className="font-bold">Casier:</span>
                  ...
                  <table className="w-full text-left">
                    <thead>
                      <tr className="border-y border-black/10 text-sm md:text-base">
                        ...
                        <th className="text-right">PREȚ UNITAR</th>
                  ...
                  <div className="mt-4 flex flex-col items-end space-y-2">
                    <div className="flex w-full justify-between border-t border-black/10 pt-2">
                      ...
                      <span>{invoiceInfo.subtotal.toFixed(2)} RON</span>
                    </div>
                    <div className="flex w-full justify-between">
                      <span className="font-bold">Discount:</span>
                      <span>{invoiceInfo.discountRate.toFixed(2)} RON</span>
                    </div>
                    <div className="flex w-full justify-between">
                      <span className="font-bold">Taxe:</span>
                      <span>{invoiceInfo.taxRate.toFixed(2)} RON</span>
                    </div>
                    <div className="flex w-full justify-between border-t border-black/10 py-2">
                      ...
                      <span className="font-bold">
                        ...
                        {invoiceInfo.total % 1 === 0
                          ? invoiceInfo.total
                          : invoiceInfo.total.toFixed(2)} RON
                      </span>
                    </div>
                  </div>
                </div>
